...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background dark">
      {/* Navbar */}
      <nav className="flex items-center justify-between p-4 bg-secondary border-b border-accent/20 sticky top-0 z-50">
        ...
        <div className="flex items-center space-x-4">
          <Button 
            variant="outline" 
            className="border-accent text-foreground hover:bg-accent/20" 
      ...
      <section className="min-h-[calc(100vh-4rem)] flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="text-primary">Accelerate</span> Your Growth at VIT-AP
          </h1>
          <p className="text-lg mb-6 text-muted-foreground">
            A comprehensive toolkit designed to help you track your skills, attendance, CGPA, and much more - all in one place.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            ...
            <Button 
              variant="outline" 
              className="px-6 py-3 text-lg border-accent text-foreground hover:bg-accent/20"
            >
              Learn More
            </Button>
          </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <div className="text-xl font-bold text-foreground flex items-center justify-center md:justify-start">
                <span className="text-primary">VIT</span>
                <span className="ml-1">Skill Space</span>
              </div>
              <p className="text-muted-foreground text-sm mt-1">A comprehensive growth toolkit for VIT-AP students</p>
            </div>
          ...
          <div className="mt-6 border-t border-accent/20 pt-6 text-center md:text-left text-muted-foreground text-sm">
            <div className="flex flex-col md:flex-row md:justify-between">
              <div className="mb-2 md:mb-0">© 2023 VIT Skill Space. All rights reserved.</div>
