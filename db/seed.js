...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var existingDecks, deckData, _loop_1, _i, deckData_1, deck, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
                    console.log("Seeding database...");
                    return [4 /*yield*/, index_1.db.query.flashcardDecks.findMany()];
                case 1:
                    existingDecks = _a.sent();
                    if (!(existingDecks.length === 0)) return [3 /*break*/, 6];
                    ...
                    _loop_1 = function (deck) {
                        var insertedDeck, cards, cardsToInsert;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, index_1.db.insert(schema.flashcardDecks).values(deck).returning()];
                                case 1:
                                    insertedDeck = (_b.sent())[0];
                                    cards = getCardsForDeck(insertedDeck.subject);
                                    if (!(cards.length > 0)) return [3 /*break*/, 3];
                                    cardsToInsert = cards.map(function (card) { return ({
                                        deckId: insertedDeck.id,
                                        question: card.question,
                                        answer: card.answer
                                    }); });
                                    return [4 /*yield*/, index_1.db.insert(schema.flashcards).values(cardsToInsert)];
                                case 2:
                                    _b.sent();
                                    _b.label = 3;
                    ...
                    _i = 0, deckData_1 = deckData;
                    _a.label = 2;
                case 2:
                    if (!(_i < deckData_1.length)) return [3 /*break*/, 5];
                    deck = deckData_1[_i];
                    return [5 /*yield**/, _loop_1(deck)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
...
function getCardsForDeck(subject) {
    switch (subject) {
        case "CS":
            return [
